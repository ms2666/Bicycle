...
signal line from Arduino pin 34 to rudder servo signal line (white/blue)
signal line from Arduino pin 36 to trim tab servo signal line (blue)

switches forward is locked, backward is unlocked
*/

#define RUDDER_MIDPOINT_OUT 90
...
// Define servo pins
const int trimServoPin= 34;
const int rudderServoPin= 36;

// Define variables
const int leftJoystickHorizontalPin= 28; // controls rudder // pin 4
const int rightJoystickHorizontalPin= 26;  // controls trim tab // pin 2
...
void loop() {
    ...
    Serial.print("nLeft joystick value: ");
    ...
    Serial.print("tRudder angle: ");
    Serial.print(rightJoystickHorizontal);
    Serial.print("tOrange: ");
